...
${OBJECTDIR}/stasm_main.o: stasm_main.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../stasm -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stasm_main.o stasm_main.cc
...
${TESTDIR}/tests/MainTest.o: tests/MainTest.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../stasm `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MainTest.o tests/MainTest.cc


${TESTDIR}/tests/main_test_runner.o: tests/main_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../stasm `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main_test_runner.o tests/main_test_runner.cc
...
${OBJECTDIR}/stasm_main_nomain.o: ${OBJECTDIR}/stasm_main.o stasm_main.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../stasm -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stasm_main_nomain.o stasm_main.cc;\
	else  \
